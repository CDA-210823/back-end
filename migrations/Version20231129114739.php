 ...
 */
final class Version20231129114739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE address ADD recipient_name VARCHAR(50) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE image ADD ext VARCHAR(20) NOT NULL');
        $this->addSql('ALTER TABLE product ADD date_add DATE NOT NULL');
        $this->addSql('ALTER TABLE user ADD last_name VARCHAR(50) DEFAULT NULL, ADD first_name VARCHAR(50) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE address DROP recipient_name');
